        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          <div className="max-w-md">
            ...
            <p className="mt-6 text-slate-400 text-lg leading-relaxed">
              Secure, reliable, and high-performance infrastructure management. Monitor your services, manage billing, and track requests all in one place.
            </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-1.5 sm:space-y-2 mb-6 sm:mb-8">
            ...
            <p className="text-xs sm:text-sm text-slate-500">Sign in to your account to continue</p>
          </div>
