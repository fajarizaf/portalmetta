...
"[project]/src/app/api/dynamic-options/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const filters = depFields.map((f, i)=>({
                field: f,
                value: depValues[i] || ""
            })).filter((x)=>x.field && x.value);
        ...
        if (mode === "static_dep") {
            ...
            const typeFilter = filters.find((f)=>{
                ...
                return field.includes("cross_connect_type") || val === "Fiber Optic" || val === "UTP";
            });
            ...
            if (dt) {
                const recs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRecord.findMany({
                    where: {
                        docTypeId: dt.id,
                        ...branchId ? {
                            branchId
                ...
                const toCamel = (s)=>s.replace(/[_-]([a-zA-Z])/g, (_, c)=>String(c).toUpperCase());
                const filtered = filters.length > 0 ? recs.filter((r)=>{
                    const d = r.data ?? {};
            ...
            const goodsInItemType = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docType.findUnique({
                where: {
                    key: "goods_in_item"
                }
            });
            const goodsOutItemType = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docType.findUnique({
                where: {
                    key: "goods_out_item"
                }
            });
            ...
            const goodsInItems = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRow.findMany({
                where: {
            ...
            const goodsOutItems = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRow.findMany({
                where: {
            ...
            const client = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"];
            if (client && typeof client[modelProp]?.findMany === "function") {
                ...
                const scoped = hasBranchField ? recs.filter((r)=>{
                    const raw = r["branchId"] ?? r["branch_id"];
                    const v = typeof raw === "string" ? raw : String(raw ?? "");
                    return v === branchId;
                }) : recs;
                const toCamel = (s)=>s.replace(/[_-]([a-zA-Z])/g, (_, c)=>c.toUpperCase());
                const filtered = filters.length > 0 ? scoped.filter((r)=>{
                    for (const fl of filters){
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6bc5eed2._.js.map