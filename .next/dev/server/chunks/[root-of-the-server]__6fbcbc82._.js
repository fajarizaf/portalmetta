...
"[project]/src/app/api/product-specs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (!productId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "productId required"
        }, {
            status: 400
        });
        const specs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productSpecField.findMany({
            where: {
                productId
            }
        });
        const outFields = specs.map((s)=>({
                id: s.id,
                key: s.key,
                label: s.label,
                type: s.type,
        ...
        for (const s of specs){
            ...
            if (targetKey) {
                const targetDT = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docType.findUnique({
                    where: {
                        key: targetKey
                    }
                });
                if (targetDT) {
                    ...
                    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRecord.findMany({
                        where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6fbcbc82._.js.map