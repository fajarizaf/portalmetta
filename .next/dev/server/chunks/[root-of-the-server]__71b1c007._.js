...
function ensureClient() {
    ...
    const c = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PrismaClient"]({
        log: [
            "error"
        ],
        adapter
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            authorize: async (credentials)=>{
                ...
                if (!user) return null;
                const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(credentials.password, user.passwordHash);
                if (!ok) return null;
...
function createQRPayload(recordId, companyId, token) {
...
async function generateQRCodeDataURL(payload) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].toDataURL(jsonStr, {
        width: 300,
        margin: 2,
        color: {
            dark: "#000000",
...
async function generateQRCodeBuffer(payload) {
    const jsonStr = JSON.stringify(payload);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].toBuffer(jsonStr, {
        width: 300,
        margin: 2,
        color: {
            dark: "#000000",
...
async function validateQRToken(token) {
    const dt = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docType.findUnique({
        where: {
            key: "visitor_request"
        }
    });
    if (!dt) return {
        valid: false,
        error: "Visitor request DocType tidak ditemukan"
    };
    const records = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRecord.findMany({
        where: {
            docTypeId: dt.id
        },
        take: 1000
    ...
    if (recordStatus !== "approved") {
        ...
        return {
            valid: false,
            error: `Visitor request belum di-approve (status: ${statusLabel})`
        };
    }
    // Fetch visitor rows from DocRow (the `visitors` TABLE field stores data here)
    const visitorRows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRow.findMany({
        where: {
            recordId: record.id
        },
        orderBy: {
...
async function logScanActivity(params) {
    const logEntry = {
    ...
    const record = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRecord.findUnique({
        where: {
            id: params.recordId
        }
    });
    if (!record) return;
    const data = record.data ?? {};
    const scanLog = Array.isArray(data["__scan_log"]) ? data["__scan_log"] : [];
    scanLog.push(logEntry);
    // Keep only last 100 scan logs
    const trimmedLog = scanLog.slice(-100);
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].docRecord.update({
        where: {
            id: params.recordId
        },
        data: {
            data: {
                ...data,
                __scan_log: trimmedLog
            }
        }
    });
}
}),
"[project]/src/app/api/visits/checkin/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$qr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(ip)) {
    ...
    const me = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            email
        },
        include: {
    ...
    const validation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$qr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateQRToken"])(token);
    if (!validation.valid || !validation.record) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$qr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logScanActivity"])({
            recordId: "",
            token,
            action: "checkin",
            success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71b1c007._.js.map